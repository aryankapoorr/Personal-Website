...
import outsidebaseballLogo from './assets/outsidebaseball.png';
          ...
          <div className="container">
            <div className="flex items-center justify-between h-14 sm:h-16 md:h-18 transition-vh">
              <div className="flex items-center gap-3">
                ...
                <h1 className={`hidden md:block text-lg sm:text-xl md:text-2xl font-semibold text-white ${getResponsiveClasses('typography')}`}>
                  Aryan Kapoor
                </h1>
              </div>
              ...
              <nav className="hidden md:flex space-x-4 sm:space-x-6 lg:space-x-8">
                ...
                <div className="border-l border-gray-600/50 pl-4 ml-2 flex items-center">
                  <a
                    href="https://outsidebaseball.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Outside Baseball"
                    className="opacity-80 hover:opacity-100 transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(78,130,192,0.6)] hover:scale-105"
                  >
                    <img src={outsidebaseballLogo} alt="Outside Baseball" className="h-6 w-auto" />
                  </a>
                </div>
              </nav>
              ...
              <nav className="flex md:hidden items-center space-x-4">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Outside Baseball"
                  className="p-2 hover:bg-gray-800/50 rounded-lg transition-all duration-300 opacity-80 hover:opacity-100 flex items-center"
                >
                  <img src={outsidebaseballLogo} alt="Outside Baseball" className="h-5 w-auto" />
                </a>
              </nav>
            </div>
          </div>
